...
class OTUnawareFairRegressor(BaseEstimator, RegressorMixin):
    ...
    (find the barycenter and estimer the transport plan).
    
    1. Solves the OT problem to find fair targets (barycenters) for training data.
    2. Estimate the transport plan from the (eta, delta+-) distribution to barycenter distribution.
    ...
    def fit(self, X, y, s):
        ...
        # recover the fair barycenter by equation (13)
        ...
        # calculer y_fair by eq 13 and v = m#pi*
